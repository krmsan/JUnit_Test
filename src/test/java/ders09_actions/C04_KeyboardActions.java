...
public class C04_KeyboardActions extends TestBase {
    ...
    public void test01(){
       ...
       // WebElement ar= driver.findElement(By.xpath("//span[@class='s-heavy'])[1]"));// hata verdi burda

       // ar.clear();
        //ar.sendKeys("samsung a71"+Keys.ENTER);
        //(//span[@class='s-heavy'])[1] nutella yazan kısım
