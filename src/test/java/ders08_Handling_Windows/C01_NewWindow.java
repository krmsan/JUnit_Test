...
public class C01_NewWindow {
    ...
    public void test01() throws InterruptedException {
        ...
        driver.switchTo().window(ilkSayfaHandleDegeri); //tekrar yandaki taba gecmek için veya ilk acılan window a
       // driver.navigate().back();
        actualUrl= driver.getCurrentUrl();
       // expectedKelime ="wisequarter";
       expectedKelime ="amazon";
      // expectedKelime ="about:blank";//geri donunce boyle oldu cunku bu tabda baska bişey acılmamıstı
        Assert.assertTrue(actualUrl.contains(expectedKelime));
        Thread.sleep(3000);
    }
}
