...
public class C03_ReadExcel {
    ...
    public void test01() throws IOException {
        ...
        String dosyaYolu= "src/test/java/ders12_WebTable_excel/ulkeler.xlsx";//ders12_WebTable_excel/ulkeler.xlsx source root
        FileInputStream fis = new FileInputStream(dosyaYolu);//src/test/java/ders12_WebTable_excel/ulkeler.xlsx content root
