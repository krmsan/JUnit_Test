...
public class C02_ExplicitlyWait {
    ...
    public void explicitWaitTest() {
        ...
        //wait.until(ExpectedConditions.visibilityOf(locateri yaz element görunuyorsa))
        //alttaki iki satırla sonraki tek satır aynı sey     - direkt atama yapmıs

        //wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//p[@id='message']")));//webelement doner
        //WebElement itsGoneElementi=driver.findElement(By.xpath("//p[@id='message']"));
